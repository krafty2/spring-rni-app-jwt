...
public class RniController {
	...
	public List<LieuMesure> rechercheAvance2(
		...
		List<LieuMesure> detailLieu = readObjectTraitement.traitementAPRL(annee, region, province, localite, mesureService);
		return detailLieu;
	}
	...
	public List<LieuMesure> toutLesLieux(){
		...
		for (Site site : sites) {
			...
			LieuMesure villeSite = new LieuMesure(idSite, nomSite, idVille,
	...
	public List<LieuMesure> detailLieu(@PathVariable Long id){
		//ObjectTraitement objectTraitment = new ObjectTraitement();
		ReadObjectTraitement readObjectTraitement = new ReadObjectTraitement();
		List<LieuMesure> detailLieu = readObjectTraitement.avecId(siteService, id);
